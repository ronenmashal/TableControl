...
namespace MagicSoftware.Common.Controls.Table.Extensions
{
   internal class DataGridNavigationExtender : ElementExtenderBase<DataGrid>
   {
      ...
      protected override void Setup()
      {
         ...
         inputService.RegisterMouseActionGestures(MouseClicked, new MouseGesturesFactory(MouseAction.LeftClick, InputGesturesFactory.AllCombinationsOf(ModifierKeys.Control, ModifierKeys.Shift)));
      }
